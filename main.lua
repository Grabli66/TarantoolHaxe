...
InternalHandler.prototype = _hx_a(
  ...
  'ProcessHandshake', function(self) 
    local s = self._channel:ReadUntil("\r\n");
    local head = s:split(": ");
...
Main.main = function() 
  ...
  wsock:OnConnect(function(p,c) 
    haxe.Log.trace("CONNECT",_hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=21,className="Main",methodName="main"}));
  end);
  wsock:OnData(function(p1,c1,data) 
    haxe.Log.trace(data:toString(),_hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=25,className="Main",methodName="main"}));
  end);
  wsock:OnDisconnect(function(p2) 
    haxe.Log.trace("DISSCON",_hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=29,className="Main",methodName="main"}));
  end);
  wsock:OnError(function(p3,e) 
    haxe.Log.trace(e,_hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=33,className="Main",methodName="main"}));
  end);
...
TcpSocket.__interfaces__ = {IChannel}
